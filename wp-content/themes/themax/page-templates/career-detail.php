...
<main class="main" data-namespace="careerDetail">
        <section class="careerdetail_info">
                    ...
                    <div class="careerdetail_info_content">
                        ...
                        <div class="careerdetail_info_content_des">
                            <div class="careerdetail_info_content_des_item">
                                <div class="careerdetail_info_content_des_item_title h5 h6_mb heading">M?c tiÃªu cÃ´ng
                                    vi?c
                                </div>
                                <div class="careerdetail_info_content_des_item_inner">
                                    <div class="careerdetail_info_content_des_item_txt txt_16">Thi?t k? ?n ph?m truy?n
                                        thÃ´ng
                                        s? nh?t quÃ¡n, d?p, hi?u qu? cho social, banner ads, website/landing, Ã½ tu?ng
                                        video
                                        clip ads...</div>
                                </div>
                            </div>
                            <div class="careerdetail_info_content_des_item">
                                <div class="careerdetail_info_content_des_item_title h5 h6_mb heading">Nhi?m v? chÃ­nh
                                </div>
                                <div class="careerdetail_info_content_des_item_inner">
                                    <div class="careerdetail_info_content_des_item_txt txt_16">LÃªn concept, idea,
                                        moodboard,
                        ...
                        <div class="careerdetail_info_content_form">
                            <div class="careerdetail_info_content_form_title heading h5 h6_mb cl_red">N?P ÃON ?NG TUY?N
                                V? TRÃ
                                NÃ€Y
                            </div>
                            <form class="careerdetail_form">
                                <div class="careerdetail_form_row">
                                    <input type="text" placeholder="Your name" class="careerdetail_form_input">
                                </div>
                                <div class="careerdetail_form_row col-2">
                                    <input type="email" placeholder="Email address" class="careerdetail_form_input">
                                    <input type="text" placeholder="Phone number" class="careerdetail_form_input">
                                </div>
                                ...
                                <div class="careerdetail_form_row">
                                    <input type="text" placeholder="Link Portfolio" class="careerdetail_form_input">
                                </div>
                                <div class="careerdetail_form_row">
                                    <input type="text" placeholder="A brief introduction about myself"
                    ...
                    <div class="careerdetail_info_other">
                        <div class="careerdetail_info_other_inner">
                            ...
                            <div class="careerdetail_info_other_list">
                                <a href="#" class="career_why_list_item item_line">
                                    <div class="career_why_list_item_position item_line_title txt_18 cl_linear">
                                        Copywriter - Content Creation</div>
                                    <div class="home_case_content_item_txt_icon">
                                        ...
                                        <div class="home_case_content_item_txt_icon_wrap svg_full active"><svg
                        ...
                        <div class="careerdetail_info_other_share">
                            ...
                            <div class="careerdetail_info_other_share_social">
                                <a href="#" class="careerdetail_info_other_share_social_icon svg_full">
