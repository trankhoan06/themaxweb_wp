...
<main class="main" data-namespace="caseStudyDetail">
        <section class="casestudydetail_hero">
            <div class="casestudydetail_img img_full">
                <img src="<?php echo get_template_directory_uri(); ?>/images/bg_case_study.webp" alt="">
            </div>
            ...
            <div class="container">
                <div class="casestudydetail_hero_content">
                    <div class="casestudydetail_hero_content_img img_full">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/logo_case_study.webp" alt="">
                    </div>
                    <div class="casestudydetail_hero_content_txt txt_16 txt_medium txt_uppercase txt_center">DAT XANH
                        GROUP
                    </div>
                    ...
                    <div class="home_case_content_list right_full left_full">
                        <div class="home_case_content_item">
                            <div class="home_case_content_item_des">
                                <div class="home_case_content_item_des_txt txt_15 txt_medium">PREVIOUS PROJECT</div>
                            </div>
                        ...
                        <div class="home_case_content_item">
                            <div class="home_case_content_item_des">
                                <div class="home_case_content_item_des_txt txt_15 txt_medium">NEXT PROJECT</div>
                            </div>
                            <div class="home_case_content_item_img_outer">
                                <div class="home_case_content_item_img img_full">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/case.webp" alt="">
