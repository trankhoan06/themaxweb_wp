                ...
                <div class="about_hero_img svg_full">
                    <svg width="641" height="117" viewBox="0 0 641 117" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <foreignObject width="100%" height="100%" mask="url(#video-mask)">
                            ...
                            <video src="<?php echo get_template_directory_uri(); ?>/images/video_button.mp4" autoplay loop muted playsinline
                ...
                <div class="about_hero_content grid">
                    <div class="about_hero_content_left">
                        <div class="about_hero_content_txt txt_18">
                            <?php echo wp_kses_post(tr_posts_field('about_hero_desc') ?: 'TheMax is a <span class="cl_red txt_medium"> Digital Marketing Agency </span>in Saigon with a team boasting 10-20 years of experience in content creation, digital tool development, and communication campaign implementation for real estate projects.'); ?>
                        </div>
                    </div>
        ...
        <section class="about_impressive">
            <div class="container grid">
                <div class="about_impressive_left">
                    <div class="about_impressive_left_subtitle block_arrow txt_16 txt_uppercase"><?php echo esc_html(tr_posts_field('about_impr_subtitle') ?: 'IMPRESSIVE NUMBERS'); ?>
                    </div>
                ...
                <div class="about_impressive_right">
                    <div class="about_impressive_right_title heading h2 h4_mb cl_white"><?php echo esc_html(tr_posts_field('about_impr_title') ?: 'We have completed hundreds of design and communication projects for real estate developer.'); ?></div>
                    <div class="about_impressive_right_des txt_16"><?php echo nl2br(esc_html(tr_posts_field('about_impr_desc') ?: 'Such as: Nam Long, Phu Long, Phu My Hung, Khang Dien, Dat Xanh, TTC Land, Novaland, GamudaLand, SP Setia (Malaysia), DKRH…')); ?></div>
...
?>
                        <div class="about_impressive_right_list_item">
                            <div class="about_impressive_right_list_item_num cl_red heading h1 h1_mb"><?php echo esc_html($impr_item['number'] ?? ''); ?></div>
                            <div class="about_impressive_right_list_item_des txt_18 txt_medium"><?php echo esc_html($impr_item['label'] ?? ''); ?></div>
                        </div>
<?php
    endforeach;
else:
?>
                        <div class="about_impressive_right_list_item">
                            <div class="about_impressive_right_list_item_num cl_red heading h1 h1_mb">500+</div>
                            <div class="about_impressive_right_list_item_des txt_18 txt_medium">Complete the project
                            </div>
                        </div>
                        <div class="about_impressive_right_list_item">
                            <div class="about_impressive_right_list_item_num cl_red heading h1 h1_mb">500+</div>
...
<?php endif; ?>
        ...
        <section class="about_best">
            <div class="container">
                <div class="about_best_subtitle block_arrow txt_16"><?php echo esc_html(tr_posts_field('about_best_subtitle') ?: 'WHAT WE DO BEST'); ?></div>
                <div class="about_best_title h2 h4_mb heading cl_linear"><?php echo wp_kses_post(tr_posts_field('about_best_title') ?: 'We <span class="cl_linear_red txt_uppercase">MAXIMIZE ONLINE POWER</span><br> for your brand\'s with comprehensive<br> digital marketing services.'); ?></div>
                <div class="about_best_inner grid">
                    <div class="about_best_left svg_full">
                        <svg width="536" height="478" viewBox="0 0 536 478" fill="none"
                            ...
                            <path d="M525.136 0.5L368.354 216.774L280.614 92.9727L347.569 0.5H525.136Z" stroke="#262626"
                                fill="transparent" />
                            <path opacity="0.1"
                                d="M183.009 0H2.10352L174.594 236.649L0 477.524H180.905L355.5 236.649L183.009 0Z"
                                fill="#E62636" />
                            <path
                    ...
                    <div class="about_best_right txt_18">
                        <div class="about_best_right_des"><?php echo esc_html(tr_posts_field('about_best_desc') ?: 'THEMAX provides a complete digital service package from marketing strategy development, content creation, CGI animation, project introduction films, VR360 web development, UI/UX website design, landing page design, web application and mobile application development… to planning and implementing digital marketing campaigns.'); ?></div>
                        <div class="about_best_right_cap cl_red txt_medium"><?php echo esc_html(tr_posts_field('about_best_cap') ?: 'We are Digital Marketing specializing in real estate industry.'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="about_team">
            <div class="container">
                <div class="about_team_subtitle txt_uppercase txt_16 block_arrow txt_medium"><?php echo esc_html(tr_posts_field('about_team_subtitle') ?: 'THE TEAM'); ?></div>
                <div class="about_team_title txt_center h2 h4_mb heading cl_linear"><?php echo nl2br(esc_html(tr_posts_field('about_team_title') ?: 'We take pride in cultivating a fun, creative, and inspiring work environment.')); ?></div>
                <div class="about_team_des txt_center txt_16"><?php echo nl2br(esc_html(tr_posts_field('about_team_desc') ?: "Step into our vibrant Vietnam office to meet a dynamic team of thinkers\nand creators, always ready to push the boundaries of digital growth.")); ?></div>
                <div class="about_team_content">
                    ...
                    <div class="about_team_content_bgright middle img_full">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pattern_right.webp" alt="">
                    </div>
...
?>
                        <div class="about_team_content_item item_line">
                            ...
                            <div class="about_team_content_item_title item_line_title cl_linear h5 heading "><?php echo esc_html($team_item['title'] ?? ''); ?></div>
                            <div class="about_team_content_item_des txt_14"><?php echo nl2br(esc_html($team_item['desc'] ?? '')); ?></div>
                        </div>
<?php
    endforeach;
else:
...
?>
                        <div class="about_team_content_item item_line">
                            <div class="about_team_content_item_icon img_full">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/icon-careers.svg" alt="">
                            </div>
                            <div class="about_team_content_item_title item_line_title cl_linear h5 heading ">Insight
                            </div>
                            <div class="about_team_content_item_des txt_14">Luôn lắng nghe và thấu hiểu sản phẩm, thấu hiểu mong muốn của khách hàng nhằm mang lại hiệu quả thiết thực cho khách hàng trong từng chiến dịch truyền thông.</div>
                        </div>
<?php
    endfor;
endif;
                ...
                <div class="about_team_card">
                    <div class="about_team_card_item">
                        ...
                        <div class="about_team_card_item_content">
                            <div class="about_team_card_item_content_title heading h5 cl_linear"><?php echo esc_html(tr_posts_field('about_team_card_title') ?: 'Driven by Innovation'); ?></div>
                            <div class="about_team_card_item_content_des txt_14"><?php echo nl2br(esc_html(tr_posts_field('about_team_card_desc') ?: "At TheMax, we don't just follow trends; we create solutions. Our team thrives on data-driven strategy and bold creativity, ensuring every digital product we touch delivers real impact and sustainable growth.")); ?></div>
