    ...
    <main class="main" data-namespace="career">
        <section class="service_hero">
            <div class="container grid">
                <h1 class="service_hero_left heading h1 h4_mb cl_linear"><?php echo tr_posts_field('career_hero_title'); ?></h1>
                <div class="service_hero_right">
                    <div class="service_hero_right_txt txt_18"><?php echo tr_posts_field('career_hero_desc'); ?></div>
                </div>
                <a href="<?php echo esc_url(tr_posts_field('career_hero_btn_link') ); ?>" class="service_hero_right_discover hover_txt txt_16 cl_eb">
        ...
        <section class="career_why">
            <div class="container">
                <div class="career_why_info grid">
                    <div class="career_why_info_left">
                        <div class="career_why_info_subtitle block_arrow"><?php echo esc_html(tr_posts_field('career_why_subtitle') ); ?></div>
                    </div>
                    <div class="career_why_info_content">
                        <div class="career_why_info_content_title heading h2 h4_mb cl_linear"><?php echo nl2br(esc_html(tr_posts_field('career_why_title'))); ?></div>
                        <div class="career_why_info_content_subtitle heading h6 cl_red"><?php echo nl2br(esc_html(tr_posts_field('career_why_subtitle'))); ?></div>
...
?>
                            <div class="career_why_info_content_card_item item_line">
                                ...
                                <div class="career_why_info_content_card_item_des txt_14"><?php echo esc_html($item['desc'] ?? ''); ?></div>
                            </div>
<?php
    endforeach;
endif;
?>
                ...
                <div class="career_why_img">
                    ...
                    <div class="career_why_img_txt heading h4 h5_mb cl_linear"><?php echo esc_html(tr_posts_field('career_why_bottom_text') ); ?></div>
                </div>
            ...
            <div class="container">
                <div class=" about_cta_inner_content">
                    <div class="about_cta_inner_content_title grid">
                        <div class="about_cta_inner_content_title_txt heading h2 cl_linear h5_mb"><?php echo nl2br(esc_html(tr_posts_field('career_cta_title') )); ?></div>
                        <div class="about_cta_inner_content_des txt_18"><?php echo nl2br(esc_html(tr_posts_field('career_cta_desc') )); ?></div>
