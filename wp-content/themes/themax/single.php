...
if (have_posts()) : while (have_posts()) : the_post();
    $hero_bg = wp_get_attachment_image_url(tr_posts_field('hero_bg'), 'full') ?: get_template_directory_uri() . '/images/bg_case_study.webp';
    $hero_logo = wp_get_attachment_image_url(tr_posts_field('hero_logo'), 'full') ?: get_template_directory_uri() . '/images/logo_case_study.webp';
    $hero_subtitle = tr_posts_field('hero_subtitle') ?: 'DAT XANH GROUP';
    $info_list = tr_posts_field('info_list') ?: [];
    $blog_items = tr_posts_field('blog_items') ?: [];
    $cta_line1 = tr_posts_field('cta_line1') ?: 'Have a Project in Mind,';
    $cta_line2 = tr_posts_field('cta_line2') ?: 'Start your project';
    $cta_highlight1 = tr_posts_field('cta_highlight1') ?: 'Now';
    $cta_highlight2 = tr_posts_field('cta_highlight2') ?: 'Tell Us';
?>
<main class="main" data-namespace="caseStudyDetail">
        <section class="casestudydetail_hero">
            ...
            <div class="container">
                <div class="casestudydetail_hero_content">
                    <div class="casestudydetail_hero_content_img img_full">
                        <img src="<?php echo esc_url($hero_logo); ?>" alt="">
                    </div>
                    <div class="casestudydetail_hero_content_txt txt_16 txt_medium txt_uppercase txt_center"><?php echo esc_html($hero_subtitle); ?>
                    </div>
        ...
        <section class="casestudydetail_content">
            <div class="casestudydetail_content_info">
                <div class="container grid">
                    <?php if (!empty($info_list)) : foreach ($info_list as $index => $info) : ?>
                    <div class="casestudydetail_content_info_item item<?php echo $index + 1; ?>">
                        <div class="casestudydetail_content_info_item_titlle txt_14 txt_uppercase"><?php echo esc_html($info['title']); ?></div>
                        <div class="casestudydetail_content_info_item_content txt_16"><?php echo esc_html($info['content']); ?></div>
                    </div>
                    <?php endforeach; else : ?>
                    <div class="casestudydetail_content_info_item item1">
                        <div class="casestudydetail_content_info_item_titlle txt_14 txt_uppercase">CATEGORY</div>
                        <div class="casestudydetail_content_info_item_content txt_16">Website, Branding</div>
                    </div>
                    <div class="casestudydetail_content_info_item item2">
                        <div class="casestudydetail_content_info_item_titlle txt_14 txt_uppercase">CATEGORY</div>
                        <div class="casestudydetail_content_info_item_content txt_16">Website, Branding</div>
                    </div>
                    <div class="casestudydetail_content_info_item item3">
                        <div class="casestudydetail_content_info_item_titlle txt_14 txt_uppercase">CATEGORY</div>
                        <div class="casestudydetail_content_info_item_content txt_16">Website, Branding</div>
                    </div>
                    <div class="casestudydetail_content_info_item item4">
                        <div class="casestudydetail_content_info_item_titlle txt_14 txt_uppercase">CATEGORY</div>
                        <div class="casestudydetail_content_info_item_content txt_16">Website, Branding</div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="casestudydetail_content_blog_wrap">
                        <div class="casestudydetail_content_blog">
                            <div class="casestudydetail_content_blog_inner">
                                <?php if (!empty($blog_items)) : foreach ($blog_items as $item) : 
                                    $item_img = wp_get_attachment_image_url($item['image'], 'full') ?: get_template_directory_uri() . '/images/case_study_detail_img.webp';
                                ?>
                                <div class="casestudydetail_content_blog_item">
                                    <div class="casestudydetail_content_blog_item_info">
                                        <div class="casestudydetail_content_blog_item_info_title h3 heading"><?php echo esc_html($item['title']); ?></div>
                                        <div class="casestudydetail_content_blog_item_info_content">
                                            <div class="casestudydetail_content_blog_item_info_content_subtitle heading h5"><?php echo nl2br(esc_html($item['subtitle'])); ?></div>
                                            <div class="casestudydetail_content_blog_item_info_content_des txt_16"><?php echo nl2br(esc_html($item['description'])); ?></div>
                                        </div>
                                    </div>
                                    <div class="casestudydetail_content_blog_item_img">
                                        <div class="casestudydetail_content_blog_item_img_inner img_full">
                                ...
                                <div class="casestudydetail_content_blog_item">
                                    <div class="casestudydetail_content_blog_item_info">
                                        <div class="casestudydetail_content_blog_item_info_title h3 heading">The
                                            Solution
                                        </div>
                                        <div class="casestudydetail_content_blog_item_info_content">
                                            <div
                                                class="casestudydetail_content_blog_item_info_content_subtitle heading h5">
                                                Lorem
                                                ipsum dolor sit amet consectetur. Purus pharetra a purus bibendum vel
                                                eleifend
                                                viverra velit. Viverra adipiscing diam ut natoque phasellus.</div>
                                            <div class="casestudydetail_content_blog_item_info_content_des txt_16">Lorem
                                                ipsum
                                                dolor
                                                sit amet consectetur. Purus pharetra a purus bibendum vel eleifend
                                                viverra
                                                velit.
                                                Viverra adipiscing diam ut natoque phasellus. Morbi erat sed massa
                                                viverra
                                                tortor
                                                vulputate tempor. Morbi lobortis vel ante aliquet posuere quis sed.
                                                Egestas
                                                quis
                                                duis non sed risus augue.</div>
                                        </div>
                                    </div>
                                    <div class="casestudydetail_content_blog_item_img">
                                        <div class="casestudydetail_content_blog_item_img_inner img_full">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/case_study_detail_img.webp" alt="">
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
                        ...
                        <div class="casestudydetail_content_social">
                            <a href="#" class="casestudydetail_content_blog_social_icon svg_full">
...
if (empty($prev_post)) {
    $newest = get_posts(array('post_type' => 'post', 'posts_per_page' => 1, 'order' => 'DESC', 'orderby' => 'date'));
    if (!empty($newest)) $prev_post = $newest[0];
}

$next_post = get_next_post();
if (empty($next_post)) {
    $oldest = get_posts(array('post_type' => 'post', 'posts_per_page' => 1, 'order' => 'ASC', 'orderby' => 'date'));
    if (!empty($oldest)) $next_post = $oldest[0];
}

$items = array();
if (!empty($prev_post)) {
    $items[] = array('label' => 'PREVIOUS PROJECT', 'post' => $prev_post);
}
if (!empty($next_post)) {
    $items[] = array('label' => 'NEXT PROJECT', 'post' => $next_post);
}
...
?>
                        <a href="<?php echo esc_url($link); ?>" class="home_case_content_item" style="display:block; text-decoration:none;">
                            <div class="home_case_content_item_des">
                                <div class="home_case_content_item_des_txt txt_15 txt_medium"><?php echo esc_html($label); ?></div>
                            </div>
                            ...
                            <div class="home_case_content_item_txt">
                                <div class="home_case_content_item_txt_title heading cl_be h4 h5_mb"><?php echo esc_html($title); ?></div>
        ...
        <section class="about_cta">
            ...
            <div class="container grid">
                <div class=" about_cta_inner_content h2 h5_mb heading cl_linear">
                    ...
                    <?php echo esc_html($cta_line2); ?> <span class=" middle"><?php echo esc_html($cta_highlight1); ?></span> <span class="cl_red middle"><?php echo esc_html($cta_highlight2); ?></span>
