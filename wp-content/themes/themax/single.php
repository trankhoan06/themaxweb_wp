        ...
        <main class="main" data-namespace="caseStudyDetail">
            ...
            <section class="about_cta">
                <div class="about_cta_img img_full">
                    <?php $cta_img_url = wp_get_attachment_image_url($cta_img, 'full') ?: get_template_directory_uri() . '/images/img_cta.webp'; ?>
                    <img src="<?php echo esc_url($cta_img_url); ?>" alt="">
                </div>
                ...
                <div class="container grid">
                    <a href="<?php echo esc_url($cta_link); ?>" class=" about_cta_inner_content h2 h5_mb heading ">
