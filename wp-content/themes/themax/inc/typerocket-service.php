...
add_action('edit_form_after_title', function($post) {
    if ($post->post_type == 'page' && basename(get_page_template()) == "service.php") {
        ...
        echo $form->text('service_cta_text1')->setLabel("CTA Text Line 1");
        echo $form->text('service_cta_text2')->setLabel("CTA Text Highlight (white)");
        echo $form->text('service_cta_text3')->setLabel("CTA Text Highlight (red)");
        echo $form->text('service_cta_link')->setLabel("CTA Link");
        echo endBox();
